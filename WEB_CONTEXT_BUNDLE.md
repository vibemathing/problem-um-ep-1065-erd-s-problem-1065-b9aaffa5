...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-1065-erd-s-problem-1065-b9aaffa5-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-1065"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-1065-erd-s-problem-1065-b9aaffa5-v1",
      "problem_contract_sha256": "b99b8db76a21a9d03a81b6463a13500bcecb01440aca66ba753e78495d35dd19",
      "problem_id": "problem:um-ep-1065-erd-s-problem-1065-b9aaffa5",
      "route_id": "route:um-ep-1065-erd-s-problem-1065-b9aaffa5-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-1065-erd-s-problem-1065-b9aaffa5-source-fidelity-01",
      "graph_id": "graph:um-ep-1065-erd-s-problem-1065-b9aaffa5-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-1065-erd-s-problem-1065-b9aaffa5-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-1065-erd-s-problem-1065-b9aaffa5-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Are there infinitely many primes $p$ such that $p=2^kq+1$ for some prime $q$ and $k\\geq 0$? Or $p=2^k3^lq+1$?"
          },
          "statement_sha256": "f58664b279e3ebe0ff9a2a8bdc3fe51e9b9a076851509e89f80bdda330f1356c"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-1065-erd-s-problem-1065-b9aaffa5-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-1065-erd-s-problem-1065-b9aaffa5-root",
      "route_id": "route:um-ep-1065-erd-s-problem-1065-b9aaffa5-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-1065-642bc4f612c0",
        "url": "https://www.unsolvedmath.com/problems/EP-1065"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
